...
let ShortLinkService = class ShortLinkService {
    shortLinkRepository;
    constructor(shortLinkRepository) {
    ...
    async generateUniqueShortCode(longUrl) {
        ...
        throw new common_1.InternalServerErrorException('Unable to generate short code');
    }
};
exports.ShortLinkService = ShortLinkService;
exports.ShortLinkService = ShortLinkService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(short_link_entity_1.ShortLink)),
